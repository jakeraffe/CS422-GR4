...
const ValidatedResultsPage = () => {
  ...
  const coinsInfo = [
    {
      ...
      techinque: {
        video: "https://www.youtube.com/watch?v=TDGq4aeevgY",
        title: "WHAT IS ETHEREUM?",
        description:
          "Ethereum is a technology that's home to digital money, global payments, and applications. The community has built a booming digital economy, bold new ways for creators to earn online...",
    ...
    },
    {
      ...
      techinque: {
        ...
        description:
          "Bitcoin is a decentralized digital currency that enables instant payments to anyone, anywhere in the world. Bitcoin uses peer-to-peer technology to operate with no central authority...",
    ...
    },
    {
      ...
      techinque: {
        video: "https://www.youtube.com/watch?v=8_grrGPkj4c",
    ...
    },
    {
      ...
      website: "/",
      techinque: {
        video: "https://www.youtube.com/watch?v=YJVtgv6Zmq4",
        title: "Scam Technique: Pump and Dump",
        description:
          "Whycoin is using a scam techinque known as Pump and Dump. Pump-and-dump is a manipulative scheme that attempts to boost the price of a stock or security through fake recommendations....",
  ...
  const coinObj = coinsInfo.find(
    (c) => c.name === coinReceived || c.abbreviation === coinReceived
  );
        ...
        <Row className="mt-5 mb-5 ml-0 mr-0">
          <Col xs={12} md={12} lg={6}>
            <VideoPlayerNewsVRModule
              title={coinObj.techinque.title}
              description={coinObj.techinque.description}
              cite={coinObj.techinque.descriptionCite}
              vidurl={coinObj.techinque.video}
            />
          </Col>
          <Col xs={12} md={12} lg={6}>
            <Modal.Dialog className="card-info">
              <Modal.Header>
                <Modal.Title>
                  <h4>ABOUT {coinReceived}</h4>
                </Modal.Title>
              </Modal.Header>
              <Modal.Body>
                <p>
                  PRICE: <span>{coinObj.price}</span>
                </p>
                <p>
                  DEVELOPERS: <span>{coinObj.developers}</span>
                </p>
                <p>
                  DATE LAUNCHED: <span>{coinObj.dateLaunched}</span>
                </p>
                <p>
