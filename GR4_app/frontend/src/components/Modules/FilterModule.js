        ...
        return(
            <div className="row">
                ...
                <div className="col-xs-6 margins justify-content-center">
                    <DropdownButton id="dropdown-basic-button" title="Filter 1">
                        <Dropdown.Item href="#/action-1">Option 1</Dropdown.Item>
                        <Dropdown.Item href="#/action-2">Option 2</Dropdown.Item>
                    </DropdownButton>
                </div>
                <div className="col-xs-6 margins justify-content-center">
                    <DropdownButton id="dropdown-basic-button" title="Filter 2">
                        <Dropdown.Item href="#/action-1">Option 1</Dropdown.Item>
                        <Dropdown.Item href="#/action-2">Option 2</Dropdown.Item>
                ...
                <div className="col-xs-6 margins justify-content-center">
                    <DropdownButton id="dropdown-basic-button" title="Filter 3">
                        <Dropdown.Item href="#/action-1">Option 1</Dropdown.Item>
                        <Dropdown.Item href="#/action-2">Option 2</Dropdown.Item>
                        <Dropdown.Item href="#/action-2">Option 3</Dropdown.Item>
                        <Dropdown.Item href="#/action-2">Option 4</Dropdown.Item>
                    </DropdownButton>
                </div>
            </div>
        )
